...
${r"<#include"} "${r"${ctxPath}"}/base/include/jurisdiction.ftl" />
    <!-- 页面独有文件 -->
    <script type="text/javascript" src="${r"${ctxPath}"}/static/${jsPath}/${upperPackage}/${classNameLower}/add.js?v=${r"${v}"}"></script>
</head>
<body>
<article class="page-container">
    <form action="${r"${ctxPath}"}/admin/${classNameLower}/api/add" method="post" class="form form-horizontal" id="form">
        <#list datas as data>
            <#if data.isFront == '是'>
                <#if data.isDic == '是'>
        <div class="row cl">

...
<#include "${ctxPath}/base/include/jurisdiction.ftl" />
    ...
    <script type="text/javascript" src="${ctxPath}/static/base/js/menu/menu.js?v=${v}"></script>
</head>
<body>
...
<div class="page-container">
    <div class="text-c">
        菜单名称：<input type="text" class="input-text" style="width:150px" placeholder="输入菜单名称" id="NAME">
        链接地址：<input type="text" class="input-text" style="width:150px" placeholder="输入链接地址" id="URL">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <#if QX.ADD_QX == "true"><a href="javascript:;" onclick="add()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 新增菜单</a></#if>
            <#if QX.QUERY_QX == "true"><a href="javascript:;" onclick="back2Top()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe66b;</i> 返回顶级</a></#if>
        </span>
    </div>
    <div class="mt-20">

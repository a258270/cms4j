...
<#include "${ctxPath}/base/include/head.ftl" />
    <!-- 页面独有文件 -->
    <script type="text/javascript" src="${ctxPath}/static/base/js/user/user_editself.js?v=${v}"></script>
</head>
<body>
    ...
    <form action="${ctxPath}/admin/user/api/editself" method="post" class="form form-horizontal" id="form">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="chosen-select select" size="1" name="ROLE_ID" id="ROLE_ID" disabled>
